...
/**
 * check_sub_tree_Left - Checks if all nodes in a subtree are smaller than
 * a specified maximum value.
 * @node: Pointer to the node in the subtree to verify the condition.
...
/**
 * check_sub_tree_Right - Checks if all nodes in a subtree are bigger than
